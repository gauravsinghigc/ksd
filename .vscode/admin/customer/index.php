                        ...
                        if ($CounTUsers == 0) { ?>
                          ...
                          foreach ($customersid as $id) {
                            ...
                            while ($customers = mysqli_fetch_array($getusers)) {
                              ...
                              $NetBookings = TOTAL("SELECT * FROM bookings where customer_id='$executedcustomer_id'"); ?>
                              <tr>
                                ...
                                <td>
                                    <?php 
                                    $GetBookings = SELECT("SELECT * FROM bookings where customer_id='$executedcustomer_id' ORDER BY bookingid DESC");
$Bookings = mysqli_fetch_array($GetBookings);
$unit_name = strtoupper($Bookings['unit_name']);
$unit_area = $Bookings['unit_area'];

echo $unit_name." (".$unit_area.")";
?>
                                </td>
                                <td>
                                ...
                                <td class="text-primary"><?php echo $NetBookings; ?> Bookings</td>
                                <td>
