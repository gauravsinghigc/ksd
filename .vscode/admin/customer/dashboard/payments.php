            ...
            <div class="panel-body">
              <div class="row">
                ...
                <div class="col-md-12">
                  ...
                  <?php
                  $TotalPayment = 0;
                  $getpayments = SELECT("SELECT * FROM payments, bookings where payments.bookingid=bookings.bookingid and bookings.customer_id='$ViewCustomerId' order by payments.payment_id ASC");
                  $SerialNo = 0;
                  ...
                  ?>
                    <div class="data-list flex-s-b">
                      ...
                      <span class='w-pr-8'>
                        <span class='text-grey'>PaymentType</span><br>
                  ...
                  <hr>
                  <p class='text-right'>
                    <span class='text-grey h4'>Net Payable : </span>
                    <span class='bold h4'>
                      <?php echo Price($NetPayable = AMOUNT("SELECT * FROM bookings where customer_id='$ViewCustomerId'", "net_payable_amount"), "text-success", "Rs."); ?>
                    </span><br>
                    <span class='text-grey fs-12'><?php echo PriceInWords($NetPayable); ?></span>
                  </p>
                  <hr>
                  <p class='text-right'>
                    <span class='text-grey h4'>Net Paid Amount : </span>
                    <span class='bold h4'>
                  ...
                  <hr>
                  <p class='text-right'>
                    <span class='text-grey h4'>Net Balance : </span>
                    <span class='bold h4'>
                      <?php
    echo Price(round($Balance = $NetPayable - $TotalPayment, 2), "text-danger", "Rs.");
?>
