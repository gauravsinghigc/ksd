...
<head>
    ...
    <title>Other Charges Receipt Acknowledge</title>
...
<body onload="doConvert()" style="font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI' , Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans' , 'Helvetica Neue' , sans-serif !important;margin-left:1.5rem;font-size:0.9rem;">
    <section style="margin:0% auto;display:block;background-image:url('<?php echo ADMIN_URL; ?>/booking/docs/assets/bg.jpg');background-size: cover;padding: 4rem;padding-top:16rem;">
        <div>
            <h2 style="text-align:center;margin-top: -1.5rem;margin-bottom:-0.2rem !important;">Maintenance Payment Receipt<br>
                ...
                <p style="display:flex;justify-content:space-between;font-size:13px;">
                    ...
                    <span>
                        <b>Plot No :</b> <?php echo strtoupper($numbersOnly); ?>/<?php echo FETCH($BookingSql, "project_name"); ?><br>
        ...
        <div style="font-size:13px !important;">
            ...
            <p style="margin-top:0px !important;">
                <b style="font-size:13px;">Dear <?php echo FETCH($CustomerSql, "name"); ?></b>
            </p>
            <div style="padding-right:2rem !important;">
                <table style="width:100%;line-height:1rem;">
                    ...
                    <tr class="striped text-left">
                        <th class="text-left" align="left">Paying For</th>
                        <td><?php echo FETCH($DevSql, "developmentchargetitle"); ?></td>
                    </tr>
                    <tr class="striped text-left">
                        <th class="text-left" align="left">Pay Type </th>
                        <td><?php echo FETCH($DevSql, "developmentchargetype"); ?></td>
                    </tr>
                    <tr class="striped text-left">
                        <th class="text-left" align="left">Payment Mode </th>
                        <td><?php echo FETCH($DevChargeSql, "devchargepaymentmode"); ?></td>
                    </tr>
                    <tr class="striped text-left">
                    ...
                    <tr class="striped text-left">
                        <th class="text-left" align="left">Payment Source</th>
                        <td><?php echo FETCH($DevChargeSql, "devpaymentbankname"); ?></td>
                    </tr>
                    <tr class="striped text-left">
                        <th class="text-left" align="left">Payment Created At</th>
                        <td><?php echo DATE_FORMATE2("d M, Y h:i A", FETCH($DevChargeSql, "devpaymentcreatedat")); ?></td>
                    </tr>
                    <tr class="striped text-left">
                        <th class="text-left" align="left">Paid At</th>
                        <td><?php echo DATE_FORMATE2("d M, Y", FETCH($DevChargeSql, "devpaymentreleaseddate")); ?></td>
                    </tr>
                    <tr class="striped text-left">
                        <th class="text-left" align="left">Payment Details</th>
                        <td><?php echo FETCH($DevChargeSql, "devpaymentdetails"); ?></td>
                    </tr>
                    <tr class="striped text-left">
                        <th class="text-left" align="left">Payment Notes:</th>
                        <td><?php echo FETCH($DevSql, "developmentchargedescription"); ?></td>
                    </tr>
                    <tr class="striped text-left">
                        <th class="text-left" align="left">Payment Status</th>
                        <td><?php echo FETCH($DevChargeSql, "devpaymentstatus"); ?></td>
                    </tr>
                </table>
                <hr>
                <table style="width:100%;line-height:1rem;">
                    ...
                    <tr>
                        <th align="right">Previous Paid Amount For Year 2024-2025:
                            <hr>
                        </th>
                        <th align="right"> Rs. 9,323
                            <hr>
                        </th>
                    </tr>

                    <tr>
                        <td align="right">Current Paid Amount For Year 2025-2026 :</td>
                ...
                <p style="text-align:right;">
                    For any query, you can reach our [support@yashvihar.com] at our office.<br><br><br>
                    <b>WARM REGARDS</b>
                    <br>
                    For YASHVI HOSPITALITY & MANAGEMENT SERVICES.<br><br><br><br>
                    (Authorised Signatory)
                </p>
                <p style="font-size: 10px;color:grey;line-height:12px;">
                    <b> NOTE:</b><br><br>
