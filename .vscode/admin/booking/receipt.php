...
<body onload="doConvert()" style="font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI' , Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans' , 'Helvetica Neue' , sans-serif !important;margin-left:1.5rem;font-size:0.75rem;">
            ...
            <div style="padding-right:2rem !important;">
                ...
                <table style="width:100%;line-height:1rem;">
                    ...
                    <tr>
                        ...
                        <td align="right" style="color:grey;"><?php echo  Price(round($net_payable_amount - $TotalPaidTillCurrentDate - $PreviousPayment, 2), "", "Rs."); ?></td>
                    </tr>
                ...
                <p style="text-align:right;">
                    ...
                    <b>WARM REGARDS</b>
                    <br>
                    For KSD Buildtech Private Limited.<br><br><br>
    ...
    <section style="height:100%;padding:0.5rem;margin:2% auto;display:block;">
        ...
        <div style="font-size:14px !important;">
            <h4 style='text-align:right;'>Development & Other Charges</h4>
            <table style="width:100%;line-height:1rem;">
                <tr>
                    <th align="right">Descriptions</th>
                    <th align="right">Amounts</th>
