...
<body onload="doConvert()" style=" font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI' , Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans' , 'Helvetica Neue' , sans-serif !important;margin-left:1.5rem;">
  <section style="margin:0% auto;display:block;background-image:url('<?php echo ADMIN_URL; ?>/booking/docs/assets/bg.jpg');background-size: cover;padding: 4rem;padding-top:16rem;">
    <div>
      ...
      <p style="display:flex;justify-content:space-between;font-size:13px;margin-bottom:0px;">
        <span>
    ...
    <div style="font-size:13px !important;">
      ...
      <p STYLE="margin-bottom:0px !important;">
        Keeping in view of your interest in our Project “YASH VIHAR”, you are requested to pay the current outstanding within 10 days of this Demand Letter through cheque or Online Mode in favouring <b>“YASHVI HOSPITALITY & MANAGEMENT SERVICES. A/C NO. 0511001000000329, IFSC CODE - NTBL0GUR051”</b>.<br> All delayed payments made after due date shall be charged with an interest.
      </p>
      <p style="text-align:right;margin-bottom:0px;">
        <span>
          For any query, you can reach our customer care [support@yashvihar.com] at our
          office.<br>
          <b>WARM REGARDS</b><br><br><br><br>
          <b>YASHVI HOSPITALITY & MANAGEMENT SERVICES</b>
        </span>
      </p>
      <p style="font-size:10px !important;line-height:12px;color:grey;">
        <b>NOTE:</b><br>
        ...
        7. Kindly clear the due payment as per demand in favor of <b>“YASHVI HOSPITALITY & MANAGEMENT SERVICES. A/C NO. 0511001000000329, IFSC CODE - NTBL0GUR051”</b>.
        <br>
