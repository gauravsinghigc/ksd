...
<head>
  ...
  <title>Receive Maintenance Payments | <?php echo company_name; ?></title>
                ...
                <div class="panel-body">
                  <div class="row">
                    <div class="col-md-12 m-b-10">
                      <h3 class="m-t-3"><i class="fa fa-calendar app-text"></i> Receive Maintenance Payments</h3>
                    ...
                    <div class="col-md-7 col-lg-7 col-12">
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <h4 class="section-heading">Shared Maintenance Demand Letters</h4>
                          <table class="table table-striped p-1" style="font-size:11px !important;">
                            <tr>
                              ...
                              <th>DueDate</th>
                              <th>Status</th>
                              <th class="text-right">DueAmount</th>
                            </tr>

                            <tbody>
                              <?php
                              $AllMaintenanceDemands = FetchConvertIntoArray("SELECT * FROM booking_pay_req where PayReqBookingId='$bookingid'", true);
                              if ($AllMaintenanceDemands != null) {
                                foreach ($AllMaintenanceDemands as $Demands) {
                                  if ($DemandId == $Demands->PaymentRequestId) {
                                    $ActiveBTN = "btn-success";
                                    $ActiveTEXT = "Selected";
                                  } else {
                                    $ActiveBTN = "btn-default";
                                    $ActiveTEXT = "Select & Pay";
                                  }

                                  if ($Demands->PayRequestStatus == 1) {
                                    $Link = "<span class='btn btn-sm btn-success'>PAID</span>";
                                  } else {
                                    $Link = '<a href="?demand_id=' . $Demands->PaymentRequestId . '" class="btn btn-sm ' . $ActiveBTN . '">
                                        ' . $ActiveTEXT . '
                                      </a>';
                                  }
                              ?>
                                  <tr>
                                    ...
                                    <td>
                                      <a href="" class="link text-decoration-underline text-primary"><?php echo $Demands->PayReqTitle; ?></a>
                                    </td>
                                    <td>
                                      <?php echo $Demands->PayReqType; ?>
                                    </td>
                                    <td>
                                      <?php echo $Demands->PayReqPayPeriod; ?>
                                    </td>
                                    <td>
                                      <?php echo $Demands->PayReqPayingMonths; ?> Months
                                    </td>
                                    <td>
                                      <?php echo DATE_FORMATE2("d M, Y", $Demands->PayRequestDueDate); ?>
                                    </td>
                                    <td>
                                      <?php
                                      if ($Demands->PayRequestStatus == 1) {
                                        echo "<span class='btn btn-sm text-success'><i class='fa fa-check'></i> PAID</span>";
                                      } else {
                                        echo "<span class='btn btn-sm text-danger'><i class='fa fa-warning'></i> UN-PAID</span>";
                                      } ?>
                                    </td>
                                    <td>
                                      <?php echo Price($Demands->PayRequestingAmount, "text-success", "Rs."); ?>
                                    </td>
                                  </tr>
                              <?php }
                              } else {
                                echo NoDataTableView("No Maintenance Demand found!", 8);
                              }
                              ?>
                            </tbody>
                    ...
                    <div class="col-md-5 col-lg-5 col-12">
                      <form action="../../../controller/bookingcontroller.php" method="POST" class="fs-13">
                            ...
                            <div class="modal-dialog modal-md">
                              <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                  ...
                                  <button type="button" value="<?php echo $DemandId; ?>" name="GenerateDemandMaintenancePayment" style="display:none;" onclick="actionBtn('emibtn', 'Receiving Payment')" id="emibtn" class="btn btn-success">Confirm & Receive Payment</button>
                                </div>
                              </div>
                            </div>
                          </div>
