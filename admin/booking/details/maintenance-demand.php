                      ...
                      <form action="../../../controller/bookingcontroller.php" method="POST">
                        ...
                        <div class="row">
                          ...
                          <div class="from-group col-md-3">
                            ...
                            <input type="text" name="demand_percentage" value='8' id="DemandRatePerUnit" class="form-control" oninput="CalculateAmount()">
                          </div>
                          <div class="from-group col-md-3">
                            <label>Paying For Months</label>
                            <input type="number" name="PayReqPayingMonths" value="12" id='PayingMonths' oninput="CalculateAmount()" class="form-control" min="1" required="">
                          </div>
                          <div class="from-group col-md-3">
                            <label>Request Amount : &nbsp;<Span id="err" class="text-danger float-right"> </Span></label>
                            <input type="text" name="PayRequestingAmount" id="current_paying_amount" value="<?php echo round(($unit_area_in_numbers * 8) * 12); ?>" class="form-control" placeholder="" required="">
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-md-12">
